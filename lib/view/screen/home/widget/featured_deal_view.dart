    ...
    return Consumer<FeaturedDealProvider>(
      builder: (context, featuredDealProvider, child) {
        return Provider.of<FeaturedDealProvider>(context)
                    ...
                    >0&&Provider.of<FeaturedDealProvider>(context)
            .featuredDealList.isNotEmpty&&featuredDealProvider
            .featuredDealList.first.product!=null
            ? ListView.builder(
                                ...
                                child: Container(
                                  ...
                                  child: ClipRRect(
                                    ...
                                    child: FadeInImage.assetNetwork(
                                      ...
                                      fit: BoxFit.cover,
                                      image:featuredDealProvider.featuredDealProductList.isNotEmpty&&Provider.of<SplashProvider>(context, listen: false).baseUrls.productThumbnailUrl!=null?
                                          '${Provider.of<SplashProvider>(context, listen: false).baseUrls.productThumbnailUrl}'
                                          '/${featuredDealProvider.featuredDealProductList[index].thumbnail}':'https://media-exp1.licdn.com/dms/image/C560BAQGCAiaMjZ-K5Q/company-logo_200_200/0/1639389127667?e=2147483647&v=beta&t=eI5TKNJ9_VM-2M7gOwvmFkGO8BDsrSu22V8y536mVv0',
