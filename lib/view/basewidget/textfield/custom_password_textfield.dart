      ...
      child: ClipRRect(
        ...
        child: TextFormField(
          ...
          decoration: InputDecoration(
              suffixIcon: IconButton(icon: Icon(_obscureText ? Icons.visibility_off : Icons.visibility,color: Provider.of<ThemeProvider>(context).darkTheme?Colors.white70:Theme.of(context).primaryColor,), onPressed: _toggle),
